<div class="creditos">
    ...
    <div class="row">
        <div class="tipo_credito col-md-5 p-0 rounded">
            <ul class="nav nav-tabs">
                <li class="nav-item w-50"><a class="h-100 font-weight-bold nav-link text-center active text-dark border-white border-top-0 border-left-0" href="#simple" data-toggle="tab">Crédito Simple</a></li>
                <li class="nav-item w-50"><a class="h-100 font-weight-bold nav-link text-center text-dark border-white border-top-0 border-right-0" href="#revolvente" data-toggle="tab">Crédito Revolvente</a></li>
            </ul>

            <div class="tab-content bg-white">
                <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="simple-tab" id="simple">
                ...
                <div class="tab-pane fade" role="tabpanel" aria-labelledby="revolvente-tab" id="revolvente">
                    <div style="width: 80%;margin: 0 auto;">
                        <form action="">
                            <div class="col-md-12 form-group pt-3">
                                <label class="font-weight-bold" for="">Monto:</label>
                            ...
                            <div class="info col-md-12 text-justify">
                                <small>Si cuentas con garantía puedes acceder a mejores tasas y mayores montos.</small>
                                <small>Consigue hasta 3 millones sin garatía o hasta 10 millones con garantía.</small>
                            </div>
                            <div class="col-md-12 pt-3 pb-3 pr-0 pl-0">
                                <button type="submit" class="text-white w-50 d-block m-auto btn pt-1 pb-1 boton_calcular">Calcular</button>
                            </div>
                        </form>
                    </div>
                </div>
